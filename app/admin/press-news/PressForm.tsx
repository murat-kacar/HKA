...
import { createPressAction, updatePressAction } from './actions';
...
export default function PressForm({ initialData }: PressFormProps) {
    const baseAction = initialData ? updatePressAction.bind(null, initialData.id) : createPressAction;
    ...
    return (
        <div className="max-w-5xl mx-auto pb-12">
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-2xl font-bold">{initialData ? 'Basın Haberini Düzenle' : 'Yeni Basın Haberi'}</h1>
                <Link href="/admin/press-news" className="text-sm text-zinc-400 hover:text-white">İptal</Link>
            </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-zinc-300 flex items-center justify-between">
                                ...
                                <span className="text-xs text-zinc-500 font-mono">hakankarsakakademi.com/basinda-biz/</span>
                            </label>
                            <input
                                name="slug"
                                value={slug}
